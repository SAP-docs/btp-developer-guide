...
![Diagram showing the organization of the hands-on materials to implement
							observability in a full-stack CAP application on SAP BTP.](images/Implement_Observability_Based_on_the_Starter_Mission_ecb3950.png)
