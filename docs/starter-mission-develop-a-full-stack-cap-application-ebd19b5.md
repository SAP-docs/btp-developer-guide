...
![Diagram showing the organization of the hands-on materials to develop
							and deploy a Full-Stack CAP Application in SAP BTP.](images/Tutorials_Flow_Develop_a_Full-Stack_CAP_Application_68e34cd.png)
