...
![Architecture diagram of a partner SaaS application on SAP BTP with key services and integrations.](images/Partner_Sample_Application_in_SAP_BTP_Developer_s_Guide_69a117a.png)
...
![Four-step process for application development: core creation, scaling, connecting, and adding features.](images/Tutorials_in_Partner_Sample_Application_3800fcd.png)
...
![Five-step process diagram showing stages of customer-specific extensions: Create the core, Make it scale, Connect, Add features, and Extend.](images/Extension_of_Sample_Partner_App_a035752.png)
