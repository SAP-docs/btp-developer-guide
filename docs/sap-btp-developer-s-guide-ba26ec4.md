...
![Diagram showing the design-led development phases: Explore, Discover, Design, Deliver, Run and Scale.](images/Development_Process_in_the_SAP_BTP_Developer_s_Guide_f52c607.png)
